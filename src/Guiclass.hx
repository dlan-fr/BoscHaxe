package ;
  ...
  import flash.net.*;
		...
		public static function changewindow(winname:String, initalise:Bool = true):Void {
			...
			switch(winname) {
				...
				case "help14":
					...
					windowline = 0;
					addline("This isthe INSTRUMENTS tab. Click on", "INSTRUMENTS");
				...
				case "advancedhelp3":
					...
					addline("");
					addline("Limiting yourself to a given given scale is a");
	...
	while( i < numbuttons){
		  ...
		  switch(t) {
				...
				case Control.MENUTAB_CREDITS:
				  ...
				  addtextlabel(tx + 20, Std.int(Gfx.linespacing * 1)+10, "SiON softsynth library by Kei Mesuda, Haxe port by Brian Gunn", 0);
					...
					addrighttextlabel(Gfx.screenwidth - 20 - tx, (Gfx.linespacing * 4), "Haxe port by @dlan_fr",0);
		...
		public static var windowdx:Int;
		public static var windowdy:Int;
